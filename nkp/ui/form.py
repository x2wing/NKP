...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels([
            "Субъект РФ", "Модификатор библиотеки", "Полное наименование библиотеки",
            "Адрес библиотеки", "Cтатус библиотеки", "Статус библиотеки по населенному пункту",
            "Модернизирована в рамках НП \"Культура\"", "Библиотека расположена",
            "Должность ответственного", "ФИО", "Телефон", "Эл. адрес",
            "Наименование книги", "Авторы", "Аннотация", "Серия", "ISBN",
            "Издатель", "Год издания", "Тип обложки", "Жанр", "Возрастное ограничение",
            "Книга для детей и юношества", "Цена", "Кол-во экземпляров", "Итого стоимость",
            "Дата поступления", "Номер товарной накладной", "Тип книги", "Комментарий"
        ])
